...
if (isset($_POST["ubah"])) {
    ...
    if (move_uploaded_file($tmp, 'img/' . $gambar_baru)){
        $result = mysqli_query($conn, "update lamin set nama_alat_musik = '$nama', jenis_alat_musik = '$jenis', ukuran_alat_musik = '$ukuran', harga_alat_musik = '$harga', gambar = '$gambar_baru' where id = '$id'");
